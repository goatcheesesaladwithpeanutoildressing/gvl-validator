 ...
 * @returns
 */
export const getJoiBaseLookupSchema = <T>(targetSchema: ObjectSchema<T>): ObjectSchema<T> =>
  Joi.object().pattern(Joi.string().regex(POSITIVE_INTEGER_REGEXP), targetSchema);
